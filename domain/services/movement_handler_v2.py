"""
Clean MovementHandler implementation (v2).

This file is a temporary replacement to ensure the refactor uses a
single, well-formed MovementHandler while the original file is cleaned.
"""

from utils.constants import EnemyType, ItemType
