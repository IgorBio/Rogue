"""
UI components for menus and selection screens.

This module provides reusable UI components including:
- Scrolling message logs for game events
- Main menu and configuration screens
- Item selection dialogs
- Statistics and leaderboard displays
- Status panels and game over screens
"""
import curses
